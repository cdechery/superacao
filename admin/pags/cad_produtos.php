...
echo pagCad('Projetos e Ações','produtos');
?>
        ...
        <div class="conteudo">
            ...
            echo '<form method="post" action="index.php?id=cad_produtos&amp;acao=produtos" enctype="multipart/form-data">';
