...
echo pagLista('Novidades','novidades');
?>
        ...
        <div class="conteudo">
            ...
            echo '<form style="margin-top:1em;" method="post" action="index.php?id=novidades&amp;pesquisa">';
            ...
            if (!isset($_GET['pesquisa'])) {
                ...
                listas("novidades","","paginar","","novidades");

                paginacao($PGAtual,$TotalPorPG,"novidades","Data DESC","",$id,"novidades" );
                
            
            }else{
                  listas("novidades","","","","novidades"); 
            }
