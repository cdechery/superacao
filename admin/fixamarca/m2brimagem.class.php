...
// funções para redimensionamento
	 ...
	 * @return Boolean/void
	*/	
	public function redimensiona( $nova_largura = 0, $nova_altura = 0, $tipo = '', $rgb = array( 236,236,236 ) )
	{
...
// funções de manipulação da imagem
	...
	*/	
	 ...
	 * @return void
	*/	
	public function girar( $graus, $rgb = array( 236,236,236 ) ) 
	{
	...
	*/	
	public function marca( $imagem, $x = 0, $y = 0 ) 
	{
	 ...
	 * @return void
	*/	
	public function marcaFixa( $imagem, $posicao ) 
	{
