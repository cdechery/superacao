...
function listas($tabela,$AtivoSN,$paginar,$id_alt,$Tipo){
    ...
    }elseif($tabela == 'profotos' || $tabela == 'inifotos' || $tabela == 'novfotos'){
        $nomedatabela = 'fotos';
    
    }elseif($tabela == 'proarquivos' || $tabela == 'iniarquivos' || $tabela == 'novarquivos'){
    ...
    if ($tabela == 'profotos' || $tabela == 'proarquivos' || $tabela == 'novfotos' || $tabela == 'novarquivos' || $tabela == 'inifotos' || $tabela == 'iniarquivos') {
        ...
        switch ($tabela){
            ...
            case 'novidades':
                ...
                if($_POST['Data'] == '' && $_POST['Titulo'] != ''){
                    ...
                    if ($tabela == 'noticias' || $tabela == 'novidades'){
                ...
                switch ($tabela){
                    ...
                    case 'novidades':    
                            ...
                            echo '<td '.$NomeClassTh.'>'.$Data_C.'</td>';
                                ...
                                }elseif($tabela == 'novidades'){
                                    $cad_fotos    = '<a href="index.php?id=novfotos&amp;id_alt='.$ID_C.''.$setacao.'" title="Cadastrar Fotos"><i class="icon icon-picture"></i></a>';
                        ...
                        case 'novarquivos':
                                            ...
                                            $Legenda        = stripslashes($linhasdo_C['Legenda']);
                                            if ($tabela == 'profotos' || $tabela == 'inifotos' || $tabela == 'novfotos'){
