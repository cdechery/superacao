...
if ($nivel1 != '' && $nivel2 == ''){
    ...
    echo '<div class="resumos">';
                    ...
                    $NewsNotTitData   = mysql_query('SELECT * FROM novidades WHERE Ativo="S" AND Nome_URL_Amigavel="'.$nivel1.'"') or die(ErroBanco(130));
    ...
    $NewsHome2      = mysql_query('SELECT * FROM novidades WHERE Ativo="S" AND Nome_URL_Amigavel="'.$nivel1.'"') or die(ErroBanco(130));
    ...
    $destacarfotos   = mysql_query('SELECT * FROM novfotos WHERE ID_Produtos="'.$Prod_ID2.'"') or die(ErroBanco(150));
        ...
        if ($FotoPrinSoci != "" || $CountFotosM != 0 ){
            ...
            <script>
                $(function() {
                    ...
                    $NewsNot      = mysql_query('SELECT * FROM novidades WHERE Ativo="S" AND Nome_URL_Amigavel="'.$nivel1.'"') or die(ErroBanco(130));
            ...
            echo '<div class="vertodos"><p><a title="Ver todos as Novidades" href="'.$UrlAtual.'novidades/">Ver todas</a></p></div>';
     ...
     echo '<div class="resumos back_news">
            ...
            $limitar = 'LIMIT '.$pagina_teste.',';
                ...
                $NewsHome      = mysql_query('SELECT * FROM novidades WHERE Ativo="S" ORDER BY Data DESC, Titulo ASC '.$limitar.' '.$TotalPorPG) or die(ErroBanco(130));
                $pareimpar     = '1';
                while ($LNews  = mysql_fetch_array($NewsHome)){
                    ...
                    echo '
                        ...
                        echo '<img src="'.$UrlAtual.'imgs/back_grid3.png" />';
                                ...
                                echo '<a href="'.$UrlAtual.'novidades/'.$New_URL.'">Saiba mais</a>
                            </div>
                ...
                paginacao($PGAtual,$TotalPorPG,"novidades","Data DESC","S",$UrlAtual,$pagina);
